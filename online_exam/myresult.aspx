<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/usermaster.Master"  CodeBehind="myresult.aspx.cs" Inherits="online_exam.myresult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontentplaceholder" Runat="Server">
    ...
    <asp:GridView ID="gridmyresult" runat="server" GridLines="None" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-bordered" OnPageIndexChanging="gridmyresult_PageIndexChanging" PageSize="8">
        <Columns>
            <asp:BoundField DataField="exam_id" HeaderText="Exam Name" NullDisplayText="no exam name"/>
